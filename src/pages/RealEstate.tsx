...
import { Home as HomeIcon, Key, TrendingUp, ShieldCheck, MapPin, Star, ArrowRight } from 'lucide-react';
...
const cities = [
  {
    ...
    url: "#" // Replace with actual IDX search URL
  },
  {
    name: "Westlake",
              ...
              >
                <CursorProximity className="rounded-3xl border border-white/5 bg-white/[0.02] overflow-hidden hover:bg-white/[0.04] transition-colors">
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    <div className="absolute bottom-4 right-4 px-3 py-1 rounded-full bg-white text-black text-[10px] font-bold uppercase tracking-widest">
